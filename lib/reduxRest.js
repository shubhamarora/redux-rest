...
var Endpoint = exports.Endpoint = function () {
  ...
  _createClass(Endpoint, [{
    ...
    value: function list(params) {
      ...
      return this._prepareRequest(_superagent2.default.get(this.url), headers).query(params);
    }
  }, {
    key: 'retrieve',
    value: function retrieve(id) {
      ...
      return this._prepareRequest(_superagent2.default.get(this._getObjectURL(id)), headers);
    }
  }, {
    key: 'create',
    value: function create(conf) {
      ...
      return this._prepareRequest(_superagent2.default.post(this.url), headers).send(conf);
    }
  }, {
    key: 'update',
    value: function update(conf, id) {
      ...
      return this._prepareRequest(_superagent2.default[method](this._getObjectURL(id)), headers).send(conf);
    }
  }, {
    key: '_prepareRequest',
    value: function _prepareRequest(request, headers) {
      if (this.setHeaders) {
